...
**_Thanks very much to [[https://github.com/Sesu8642]] for this awesome game. I'm attempting to recreate it in JS to allow an efficient or easier online play. This is very much a work in progress. nothing much is gonna happen anytime soon._**
...
Contributions are multi-licensed under **GPL-3.0-or-later or MIT**. See [CLA](CLA.md).
